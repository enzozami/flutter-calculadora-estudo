...
import 'package:calculadora/app/module/home/widgets/text_form.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        TextForm(controller: controllerEC1),
                        TextForm(controller: operatorEC),
                        TextForm(controller: controllerEC2)
                      ],
                    ),
                    TextForm(controller: resultadoEC)
                  ],
                ),
              ),
            ),
